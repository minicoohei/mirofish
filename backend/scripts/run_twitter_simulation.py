"""
OASIS Career Simulation (Board) preset script
...
def setup_oasis_logging(log_dir: str):
    ...
    loggers_config = {
        ...
        "career.board": os.path.join(log_dir, "career.board.log"),
...
class TwitterSimulationRunner:
    ...
    async def run(self, max_rounds: int = None):
        ...
        """
        print("=" * 60)
        print("OASIS Career Simulation (Board)")
...
async def main():
    parser = argparse.ArgumentParser(description='OASIS Career Simulation (Board)')
    parser.add_argument(
        '--config', 
        type=str, 
        required=True,
