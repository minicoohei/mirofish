<template>
  <div class="process-page">
    <!-- Top Navigation -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">HR CAREER SIM</div>
      
      <!-- Center Step Indicator -->
      <div class="nav-center">
        <div class="step-badge">STEP 01</div>
        <div class="step-name">履歴書分析</div>
      </div>
    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        <div class="panel-header">
          <div class="header-left">
            ...
            <span class="header-title">リアルタイム ナレッジグラフ</span>
          </div>
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-if="graphData" class="graph-view">
            ...
            <div v-if="selectedItem" class="detail-panel">
              <div class="detail-panel-header">
                <span class="detail-title">{{ selectedItem.type === 'node' ? 'ノード詳細' : '関係性' }}</span>
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-text">オントロジー生成待機中</p>
            <p class="waiting-hint">生成完了後、自動的にグラフ構築を開始します</p>
          </div>
          
          <!-- Error state (must be before building placeholder) -->
          ...
          <div v-else-if="currentPhase === 1 && !graphData" class="graph-waiting">
            ...
            <p class="waiting-hint">まもなくデータが表示されます...</p>
          </div>
        </div>
      ...
      <!-- Right Panel: Build Flow Details -->
        ...
        <div class="process-content">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After document upload, LLM analyzes content and auto-generates ontology structure for opinion simulation (entity types + edge types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            <div class="phase-header">
              ...
              <div class="phase-info">
                <div class="phase-title">履歴書分析</div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Endpoint Description</div>
                <div class="detail-content">
                  Based on generated ontology, chunk documents and call Zep API to build knowledge graph, extracting entities and edges
                </div>
              </div>
              ...
              <div class="detail-section" v-if="graphData">
                ...
                <div class="build-result">
                  ...
                  <div class="result-item">
                    ...
                    <span class="result-label">エンティティ種別</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 2, 'completed': currentPhase > 2 }">
            <div class="phase-header">
              ...
              <div class="phase-info">
                ...
                <div class="phase-api">次のステップへ進めます</div>
              </div>
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No files to upload. Please go back to home page.'
    loading.value = false
    return
  }
...
const loadProject = async () => {
  try {
    ...
    if (response.success) {
      ...
      // Continue polling in-progress task
...
const fetchGraphData = async () => {
  try {
    // First get project info for graph_id
...
const renderGraph = () => {
  ...
  simulation.on('tick', () => {
    // Update all edge positions (including visible and clickable areas)
