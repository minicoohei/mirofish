...
const statusText = computed(() => {
  if (currentStatus.value === 'error') return 'エラー'
  if (currentStatus.value === 'completed') return '完了'
  if (currentStatus.value === 'processing') return '処理中'
  return '準備完了'
})
