...
This module wraps auto-pagination logic (with per-page retry), transparently returning complete lists.
"""
...
def fetch_all_nodes(
    ...
    """Paginate graph nodes, returning up to max_items (default 2000). Each page has built-in retry."""
    all_nodes: list[Any] = []
...
def fetch_all_edges(
    ...
    """Paginate all graph edges, returning complete list. Each page has built-in retry."""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
