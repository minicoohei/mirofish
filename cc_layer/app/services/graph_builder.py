...
class GraphBuilderService:
    """
    Graph building service
    Responsible for building knowledge graph via Zep API
    """
    ...
    def build_graph_async(
        ...
        Args:
            ...
            batch_size: Batch size for sending chunks
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is required by Zep SDK, warning from dynamic class creation, safe to ignore
        ...
        for entity_def in ontology.get("entity_types", []):
            ...
            # Create attribute dict and type annotations (Pydantic v2 requires)
    ...
    def add_text_batches(
        ...
        """Batch add text to graph, return all episode uuid list"""
        episode_uuids = []
        total_chunks = len(chunks)
    ...
    def _wait_for_episodes(
        ...
        """Wait for all episodes to complete processing (by querying each episode's processed status)"""
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict containing nodes and edges with temporal info, attributes, and detailed data
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
