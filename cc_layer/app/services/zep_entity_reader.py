...
Reads nodes from Zep graph and filters for predefined entity types
"""
...
class ZepEntityReader:
    ...
    2. Filter nodes matching predefined entity types (with labels beyond just Entity)
    3. Get related edges and nodes for each entity
    """
    ...
    def filter_defined_entities(
        ...
        Filter logic:
        - If node Labels contain only "Entity", the entity does not match predefined types, skip
